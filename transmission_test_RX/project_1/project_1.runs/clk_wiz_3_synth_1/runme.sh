...
HD_PWD='/home/dsmith/Desktop/transmission_test_split/project_1/project_1.runs/clk_wiz_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_3.vds -m64 -mode batch -messageDb vivado.pb -notrace -source clk_wiz_3.tcl
