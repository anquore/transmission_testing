...
HD_PWD='/home/dsmith/Desktop/transmission_test_split/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loopback128gbps.vds -m64 -mode batch -messageDb vivado.pb -notrace -source loopback128gbps.tcl
