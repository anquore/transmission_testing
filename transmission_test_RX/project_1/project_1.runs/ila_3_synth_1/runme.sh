...
HD_PWD='/home/dsmith/Desktop/transmission_test/project_1/project_1.runs/ila_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_3.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_3.tcl
