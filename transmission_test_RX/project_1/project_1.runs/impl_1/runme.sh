...
HD_PWD='/home/dsmith/Desktop/transmission_test_split/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log loopback128gbps.vdi -applog -m64 -messageDb vivado.pb -mode batch -source loopback128gbps.tcl -notrace
